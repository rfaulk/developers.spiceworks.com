...
`created_at`|`object`| Return tickets created within the given range. See [(datetime range)] (/developers.spiceworks.com//documentation/cloud-apps/api-basics.html#date-time-filtering) documentation for more information.
`due_at`|`object`| Return tickets whose due date is within the given range. See [(datetime range)] (/developers.spiceworks.com//documentation/cloud-apps/api-basics.html#date-time-filtering) documentation for more information.
...
`status_updated_at`|`object`| Return tickets whose status was last changed within the given range. See [(datetime range)] (/developers.spiceworks.com/documentation/cloud-apps/api-basics.html#date-time-filtering) documentation for more information.
`viewed_at`|`object`| Return tickets that were last viewed within the given range. See [(datetime range)] (/developers.spiceworks.com//documentation/cloud-apps/api-basics.html#date-time-filtering) documentation for more information.
